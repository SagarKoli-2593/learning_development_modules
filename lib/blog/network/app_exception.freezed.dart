...
mixin _$AppException {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(ServerExceptionType type, String message,
            dynamic fullErrorResponse, int? code)
        serverException,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(ServerExceptionType type, String message,
            dynamic fullErrorResponse, int? code)?
        serverException,
...
class __$$ServerExceptionCopyWithImpl<$Res>
  ...
  $Res call({
    Object? type = null,
    Object? message = null,
    Object? fullErrorResponse = freezed,
    Object? code = freezed,
  }) {
    return _then(_$ServerException(
      ...
      message: null == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as String,
      fullErrorResponse: freezed == fullErrorResponse
          ? _value.fullErrorResponse
          : fullErrorResponse // ignore: cast_nullable_to_non_nullable
              as dynamic,
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
...
class _$ServerException implements ServerException {
  ...
  @override
  final dynamic fullErrorResponse;
  @override
  final int? code;

  @override
  String toString() {
    return 'AppException.serverException(type: $type, message: $message, fullErrorResponse: $fullErrorResponse, code: $code)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.fullErrorResponse, fullErrorResponse) &&
            (identical(other.code, code) || other.code == code));
  }

  @override
  int get hashCode => Object.hash(runtimeType, type, message,
      const DeepCollectionEquality().hash(fullErrorResponse), code);
  ...
  TResult when<TResult extends Object?>({
    ...
    return serverException(type, message, fullErrorResponse, code);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return serverException?.call(type, message, fullErrorResponse, code);
  }
